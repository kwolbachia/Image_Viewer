...
//        infos.append(", ").append(is_Multicolor);
    ...
    public JPanel get_LUT_Set_Manager_Panel() {
        ...
        "  <li>Change LUT order with the mouse</li>" +
        ...
        "<p style='margin:2px 0 2px 0;'>Scans all LUTs in your ImageJ <strong>luts</strong> folder<br>" +
        "You can use the search bar and color buttons to filter the list.<br>" +
        ...
        "  Double-Click on a LUT name or press <b>Enter</b> to apply the selected LUT to your image.</p>" +
        "</p>" +
